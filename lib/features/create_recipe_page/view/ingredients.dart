...
class _IngredientsPageState extends State<IngredientsPage> {
  ...
  Widget build(BuildContext context) {
    return FeedbackListener<CreateRecipeState, CreateRecipeViewModel>(
      child: Scaffold(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return BaseFitreItem(
                                  ...
                                  isIcon: true,
                                  onChanged: () {
                                    createRecipeViewModel.toggleIngredient(
                                      item,
                                    );
                                  },
                                  title: item.name,
      ...
      itemBuilder: (_, __) {
        return Padding(
          ...
          child: Shimmer.fromColors(
            baseColor: Constant.bgBase(context),
            highlightColor: Constant.fillDark(context),
            child: Row(
              children: [
                Container(
                  width: 40,
